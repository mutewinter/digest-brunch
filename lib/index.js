...
Digest = (function() {
  ...
  Digest.prototype.onCompile = function() {
    var allFiles, filesAndDigests, filesToDigest, referenceFiles, renameMap, _ref;
    ...
    if (this.config.env.indexOf('production') === -1 && !this.options.alwaysRun) {
      ...
      if ((_ref = this.config.server) != null ? _ref.run : void 0) {
  ...
  Digest.prototype._replaceReferences = function(referenceFiles, renamedFiles) {
    var contents, match, originalFilename, originalString, processedString, referenceFile, replacementFilename, replacementMap, _i, _len, _results;
    _results = [];
