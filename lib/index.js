...
Digest = (function() {
  ...
  Digest.prototype._renameMap = function(filesAndDigests) {
    var digest, digestFilename, digestPath, directory, extname, filename, infix, infixPath, path, renameMap, _i, _len, _ref;
    renameMap = {};
    for (path in filesAndDigests) {
      ...
      _ref = this.options.infixes;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        infix = _ref[_i];
        infixPath = pathlib.join(directory, "" + filename + infix + extname);
        if (fs.existsSync(pathlib.join(this.publicFolder, infixPath))) {
